...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mypage_accountdelete.css">
...
<div class="deletecontent">
	...
	<input type="button" value="확인" class="btn btn-primary submit_btn"
			id="okbtn">
