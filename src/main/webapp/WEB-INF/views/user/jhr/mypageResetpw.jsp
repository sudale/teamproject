...
<div class="findid">
	<div class="findid_container">
		...
		<form method="post" action="${pageContext.request.contextPath }/jhr/mypageResetpw" class="find_id" onsubmit="return check()">
			<input type="hidden" name="mid" value="${mid }"><br>
			<input type="hidden" name="currpw" value="${mpw }"><br>
			<h3></h3>
			<div class="findid1">
				...
				<div class="findid_col_input">
					<div class="input_wrap">
						<div class="wrap_inner">
							<div class="ui_input">
								<input type="password" name="currpw2" class="input_space" maxlength="20" id="currpw2" placeholder="8-15자리의 영문/숫자를 함께 입력해주세요.">
							</div>
						</div>
					</div>
				</div>
