...
import com.jhta.project.service.hotelmanage.AccommodationsServiceHjy;
import com.jhta.project.service.hotelmanage.AccommodationsTempServiceHjy;
import com.jhta.project.service.hotelmanage.PeriodService_hjy;
import com.jhta.project.service.hotelmanage.Period_tempService_hjy;
import com.jhta.project.service.hotelmanage.Room_infoService_hjy;
import com.jhta.project.service.hotelmanage.Room_info_tempService_hjy;
...
//					// 2. 업로드된 파일정보 DB에 저장하기
	...
	public static void sendMail(AccommodationsVo accommodationsVo, Additional_feeVo additional_feeVoList,
		...
		String toEmail = "hodob76@gmail.com, wjdgh7578@naver.com" ; // 콤마(,)로 여러개 나열, peekaboo2189@gmail.com
