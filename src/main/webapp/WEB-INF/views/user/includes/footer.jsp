...
<div class="footer">
	<div class="foot_inner">
		...
		<div class="description">
			<p>아이럽 제주에서 멋진 여행지의 호텔 상품을 최저가로 만나보세요. 
	호텔 펜션 리조트 캠핑 등 검색하여, 고객님께서 딱 맞는 호텔 상품을 바로 찾아 예약하실 수 있도록 도와드립니다. 
	이럽 제주 에서는 국내외 유명한 호텔 사이트를 한 번에 검색하여 한눈에 비교할 수 있도록 도와 드리고 있어 특가 상품을 쉽게 찾으실 수 있습니다. 지금 바로 시작해 보세요.</p>
		</div>
