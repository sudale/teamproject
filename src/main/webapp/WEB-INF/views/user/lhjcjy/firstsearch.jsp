...
<div class="search">
	<div class="search_container">
		<form class="search_content" method="post" action="${pageContext.request.contextPath }/lhjcjy/firstsearch">
						...
						<div class="search_insert_city">
							<div class="search_city_display">
								...
								<div class="city_text_wrap">
									<div class="city_text">
										<input type="text" id="searchHotel" name="searchHotel" placeholder="test2도시 또는 호텔명을 검색해 보세요">
									</div>
								</div>
							</div>
						</div>
