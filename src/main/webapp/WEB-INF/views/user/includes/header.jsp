	...
	<div class="header_container">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/" class="logo_container">
				<div class="logo_img">
					<%-- 백그라운드로 대체 <img src="${pageContext.request.contextPath}/resources/images/main/logo1.png"> --%>
				</div>
			</a>
		</div>
		<div class="nav">
			<ul class="nav_menu">
				...
				<c:choose>
					<c:when test="${empty sessionScope.mid }">
						<li><a class="nav_board" href="${pageContext.request.contextPath }/jhr/login"><span>공지사항  </a></li>
					</c:when>
					<c:otherwise>
						<li><a class="nav_board" href="${pageContext.request.contextPath }/hjy/board/all"><span>공지사항 </span></a></li>
					</c:otherwise>
				</c:choose>
				...
				<div class="nav_account_container">
					...
					<div class="nav_mypage">
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath }/user/kjy/mypage">마이페이지 </a>
							</c:otherwise>
						</c:choose>
					</div>
					<div class="nav_login">
